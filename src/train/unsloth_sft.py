...
class UnslothLoRA(TrainingService):
    ...
    def __init__(self, training_config: TrainingConfig):
        ...
        if ALLOW_COLLATOR:
            self.use_collator = self.training_config.use_collator()
        else:
    ...
    def train(self):
        ...
        if ALLOW_COLLATOR and self.use_collator:
            collator = DataCollatorForCompletionOnlyLM(
                ...
                padding_free = self.training_config.padding_free or (self.training_config.packing and (self.training_config.packing_strategy == "bfd")),
            )
            self.print('Collator loaded')
        else:
            assert self.training_config.assistant_only_loss 
            collator = None
        ...
        self.trainer = SFTTrainer(
            ...
            args = SFTConfig(
                ...
                **self.training_config.sfttrainer_config(),
